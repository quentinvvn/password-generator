...
Label(root, text="Entrez la taille voulue", font="calibri 25").pack(pady=3)
Entry(root,font="calibri 25", textvariable=passlen).pack(pady=3)

Button(root, text="Générer", font="calibri 15", command=generate).pack(pady=7)

Entry(root,font="calibri 25", textvariable=passstr).pack(pady=5)

Button(root, text="Copier", font="calibri 15", command=copytoclipboard).pack()
